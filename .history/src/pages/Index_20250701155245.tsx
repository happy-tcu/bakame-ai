  ...
  return <div className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <svg className="absolute inset-0 w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
          ...
          <g>
            {/* Animated blue lines */}
            <path className="warp-animated-line warp-animated-line-blue" d="M 10,10 Q 50,0 90,10" fill="none" />
            <path className="warp-animated-line warp-animated-line-blue" d="M 10,90 Q 50,100 90,90" fill="none" />
            <path className="warp-animated-line warp-animated-line-blue" d="M 10,50 Q 50,60 90,50" fill="none" />
            {/* Animated purple lines */}
            <path className="warp-animated-line warp-animated-line-purple" d="M 20,20 Q 50,50 80,20" fill="none" />
            <path className="warp-animated-line warp-animated-line-purple" d="M 20,80 Q 50,50 80,80" fill="none" />
            {/* Animated green lines */}
            <path className="warp-animated-line warp-animated-line-green" d="M 50,10 Q 60,50 50,90" fill="none" />
            <path className="warp-animated-line warp-animated-line-green" d="M 30,30 Q 50,70 70,30" fill="none" />
          </g>
          <defs>
