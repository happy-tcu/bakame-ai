    ...
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      >
        <iframe
          ...
          src="https://www.youtube.com/embed/bVbRBLaTMpI?autoplay=1&mute=1&loop=1&playlist=bVbRBLaTMpI&controls=0&showinfo=0&rel=0&modestbranding=1&playsinline=1&enablejsapi=1&start=0&disablekb=1&fs=0&iv_load_policy=3"
          title="Background video"
          allow="autoplay; encrypted-media; microphone"
          style={{ pointerEvents: 'none' }}
        />
        {/* Second iframe for seamless looping - starts playing before first one ends */}
        <iframe
          className="absolute top-1/2 left-1/2 w-[177.77777778vh] h-[56.25vw] min-h-full min-w-full -translate-x-1/2 -translate-y-1/2 opacity-0"
          src="https://www.youtube.com/embed/bVbRBLaTMpI?autoplay=1&mute=1&loop=1&playlist=bVbRBLaTMpI&controls=0&showinfo=0&rel=0&modestbranding=1&playsinline=1&enablejsapi=1&start=0&disablekb=1&fs=0&iv_load_policy=3"
