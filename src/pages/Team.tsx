...
const Careers = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      {/* Navigation */}
      <nav className="flex justify-between items-center p-6 md:p-8 border-b border-gray-200">
        <div className="text-2xl font-bold text-gray-900">Bakame AI</div>
        <div className="hidden md:flex space-x-8">
          ...
          <a href="/team" className="text-gray-900 font-medium border-b-2 border-blue-500">Careers</a>
        </div>
      </nav>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className={`mb-20 transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
          <h2 className="text-3xl font-bold mb-12 text-gray-900">Benefits & perks</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold text-gray-900 mb-2">Health & wellness</h3>
                <p className="text-gray-600">Comprehensive medical, dental, and vision coverage</p>
              </div>
              <div>
                <h3 className="font-semibold text-gray-900 mb-2">Learning & development</h3>
                <p className="text-gray-600">$3,000 annual budget for conferences and courses</p>
              </div>
              <div>
                <h3 className="font-semibold text-gray-900 mb-2">Innovation time</h3>
                <p className="text-gray-600">20% time for personal projects and research</p>
              </div>
            </div>
            <div className="space-y-4">
              <div>
              ...
              <div>
                ...
                <p className="text-gray-600">Top-tier equipment plus home office setup</p>
              </div>
              <div>
                <h3 className="font-semibold text-gray-900 mb-2">Team events</h3>
                <p className="text-gray-600">Quarterly gatherings and annual retreats</p>
              </div>
            </div>
          </div>
        </div>
                ...
                <div className="flex items-start justify-between mb-4">
                  <div>
                    ...
                    <div className="flex items-center space-x-4 text-sm text-gray-600">
                      <span className="bg-gray-100 px-3 py-1 rounded-full">{job.team}</span>
        ...
        <div id="application-form" className={`transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="bg-gray-50 rounded-lg p-8">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold mb-4 text-gray-900">Apply to Bakame AI</h2>
      ...
      <footer className="border-t border-gray-200 py-12">
        <div className="max-w-4xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center">
          <div className="text-xl font-bold text-gray-900 mb-4 md:mb-0">Bakame AI</div>
          <div className="flex space-x-8 text-gray-600">
            ...
            <a href="/team" className="hover:text-gray-900 transition-colors">Careers</a>
          </div>
        </div>
        <div className="max-w-4xl mx-auto px-6 mt-8 pt-8 border-t border-gray-200 text-center text-gray-500">
