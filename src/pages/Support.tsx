...
const Support = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "We offer tiered pricing based on usage and deployment type. Educational institutions receive special pricing. Contact us for a custom quote based on your specific needs and scale."
    },
    {
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-blue-400 via-orange-400 to-blue-400 bg-clip-text text-transparent">
            Support Center
          </h1>
        ...
        <div className="bg-gradient-to-r from-blue-500/10 via-orange-500/10 to-blue-500/10 rounded-2xl p-8 text-center border border-accent/20">
          ...
          <a 
            ...
            className="inline-flex items-center bg-gradient-to-r from-blue-500 to-orange-500 text-white px-8 py-3 rounded-full font-semibold hover:opacity-90 transition-opacity"
          >
