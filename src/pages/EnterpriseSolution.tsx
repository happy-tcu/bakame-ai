  ...
  const useCases = [
    {
      ...
      items: [
        { title: "Order Processing", desc: "Automated order taking, status updates, and tracking information" },
        { title: "Technical Support", desc: "Intelligent troubleshooting and issue resolution guidance" },
        { title: "Account Management", desc: "Balance inquiries, payment processing, and account updates" }
      ]
    },
    {
      ...
      items: [
        { title: "HR Services", desc: "Leave requests, policy information, and benefits inquiries" },
        { title: "IT Helpdesk", desc: "Password resets, system status, and technical assistance" },
        { title: "Facilities", desc: "Room bookings, maintenance requests, and facility information" }
      ]
    },
    {
      ...
      items: [
        { title: "Lead Qualification", desc: "Automated prospect screening and scoring" },
        { title: "Product Info", desc: "Detailed product specifications and pricing" },
        { title: "Appointment Setting", desc: "Automated scheduling and calendar integration" }
      ]
    }
  ];
    ...
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <nav className="flex justify-between items-center p-6 md:p-8 border-b border-white/10 animate-fade-in">
        ...
        <div className="hidden md:flex space-x-8">
          ...
          <a href="/resources" className="text-white/70 hover:text-white transition-all duration-300 hover:scale-105 relative after:content-[''] after:absolute after:w-full after:scale-x-0 after:h-0.5 after:bottom-0 after:left-0 after:bg-purple-400 after:origin-bottom-right after:transition-transform after:duration-300 hover:after:scale-x-100 hover:after:origin-bottom-left">Resources</a>
          <a href="/team" className="text-white/70 hover:text-white transition-all duration-300 hover:scale-105 relative after:content-[''] after:absolute after:w-full after:scale-x-0 after:h-0.5 after:bottom-0 after:left-0 after:bg-purple-400 after:origin-bottom-right after:transition-transform after:duration-300 hover:after:scale-x-100 hover:after:origin-bottom-left">Team</a>
          <a href="/signup" className="text-white/70 hover:text-white transition-all duration-300 hover:scale-105 relative after:content-[''] after:absolute after:w-full after:scale-x-0 after:h-0.5 after:bottom-0 after:left-0 after:bg-purple-400 after:origin-bottom-right after:transition-transform after:duration-300 hover:after:scale-x-100 hover:after:origin-bottom-left">Sign In</a>
        </div>
      </nav>
      ...
      <div className="container mx-auto px-6 py-20">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent animate-fade-in" style={{animationDelay: '0.2s'}}>
        ...
        <div className="mb-20">
          ...
          <div className="space-y-6">
            {useCases.map((useCase, index) => (
              <div 
                key={index}
                className="bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 hover:border-white/20 transition-all duration-500 animate-fade-in overflow-hidden"
        ...
        <div className="mb-20" id="stats-section">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { value: animatedStats.cost, suffix: "%", label: "Cost Reduction", color: "green" },
              { value: animatedStats.response, suffix: "%", label: "Faster Response", color: "blue" },
              { value: animatedStats.uptime, suffix: "%", label: "Uptime", color: "purple" },
              { value: animatedStats.satisfaction, suffix: "%", label: "Customer Satisfaction", color: "orange" }
            ].map((stat, index) => (
              <div 
                key={index}
                className="text-center bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-white/20 transition-all duration-500 hover:scale-105 hover:bg-white/10 group animate-fade-in"
                style={{animationDelay: `${index * 0.1}s`}}
              >
        ...
        <div className="text-center bg-white/5 backdrop-blur-sm rounded-3xl p-12 border border-white/10 hover:border-white/20 transition-all duration-500 animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button 
              ...
              className="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-8 py-4 rounded-full font-semibold text-lg hover:from-purple-600 hover:to-pink-600 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-purple-500/25 group relative overflow-hidden"
            >
