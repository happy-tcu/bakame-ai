  ...
  return <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center bg-black overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 w-full relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center min-h-screen pt-24 pb-8">
            {/* Left content */}
      ...
      <section className="pt-12 pb-24 bg-black relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            ...
            <div className="col-span-2 md:col-span-1">
              <img 
                src="/brand-assets/Logo horizonatal white.png" 
                alt="Bakame AI" 
                className="h-8 mb-4"
              />
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a href="#features" className="text-gray-400 hover:text-white text-sm font-light transition-colors">
                    Features
                  </a>
                </li>
                <li>
                  <a href="#programs" className="text-gray-400 hover:text-white text-sm font-light transition-colors">
                    Programs
                  </a>
                </li>
                <li>
                  <a href="#research" className="text-gray-400 hover:text-white text-sm font-light transition-colors">
                    Research
                  </a>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a href="#partners" className="text-gray-400 hover:text-white text-sm font-light transition-colors">
                    Partners
                  </a>
                </li>
                <li>
                  <a href="mailto:hello@bakame.ai" className="text-gray-400 hover:text-white text-sm font-light transition-colors">
                    Contact
                  </a>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a href="/privacy" className="text-gray-400 hover:text-white text-sm font-light transition-colors" data-testid="link-privacy">
                    Privacy Policy
                  </a>
                </li>
                <li>
                  <a href="/terms" className="text-gray-400 hover:text-white text-sm font-light transition-colors" data-testid="link-terms">
                    Terms of Service
                  </a>
                </li>
              </ul>
          ...
          <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-6">
              <a href="https://twitter.com/bakameai" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-white transition-colors">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              </a>
              <a href="https://linkedin.com/company/bakameai" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-white transition-colors">
